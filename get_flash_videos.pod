...
get_flash_videos [OPTION]... URL1 [URL2] [URL3] [URLn]

get_flash_videos [OPTION]... search

=head1 DESCRIPTION

Download the Flash video from the web pages given in C<URL1>, C<URL2> and
so on, choosing suitable filenames for each.
